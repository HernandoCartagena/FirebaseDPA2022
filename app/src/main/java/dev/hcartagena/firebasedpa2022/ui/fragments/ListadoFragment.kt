...
import dev.hcartagena.firebasedpa2022.ui.fragments.adapter.CourseAdapter
    ...
    override fun onCreateView(
        ...
        db.collection("cursos")
            .addSnapshotListener{snap,e->
                if(e!=null){
                    Log.w("Firebase error","Error al listar los cursos....")
                ...
                for (dc in snap!!.documentChanges){
                    when(dc.type){
                        ...
                        DocumentChange.Type.REMOVED ->{
                            lstCourses.add(
                                CourseModel(
                                    dc.document.data["description"].toString(),
